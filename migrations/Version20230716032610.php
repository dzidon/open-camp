 ...
 */
final class Version20230716032610 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE camper_camper (camper_source INT NOT NULL, camper_target INT NOT NULL, INDEX IDX_5EA1AEFFA1E79B5A (camper_source), INDEX IDX_5EA1AEFFB802CBD5 (camper_target), PRIMARY KEY(camper_source, camper_target)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
