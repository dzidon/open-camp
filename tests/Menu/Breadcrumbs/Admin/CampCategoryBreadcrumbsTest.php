...
use App\Menu\Breadcrumbs\Admin\CampCategoryBreadcrumbs;
...
class CampCategoryBreadcrumbsTest extends KernelTestCase
{
    ...
    public function testList(): void
    {
        ...
        $this->assertSame(['admin_home', 'admin_camp_category_list'], $this->getGraphNodeChildrenIdentifiers($breadcrumbsMenu));
    ...
    public function testCreate(): void
    {
        ...
        $this->assertSame('breadcrumbs', $breadcrumbsMenu->getIdentifier());
        $this->assertSame(['admin_home', 'admin_camp_category_list', 'admin_camp_category_create'], $this->getGraphNodeChildrenIdentifiers($breadcrumbsMenu));
    ...
    public function testRead(): void
    {
        ...
        $this->assertSame('breadcrumbs', $breadcrumbsMenu->getIdentifier());
        $this->assertSame(['admin_home', 'admin_camp_category_list', 'admin_camp_category_read'], $this->getGraphNodeChildrenIdentifiers($breadcrumbsMenu));
    ...
    public function testUpdate(): void
    {
        ...
        $this->assertSame('breadcrumbs', $breadcrumbsMenu->getIdentifier());
        $this->assertSame(['admin_home', 'admin_camp_category_list', 'admin_camp_category_update'], $this->getGraphNodeChildrenIdentifiers($breadcrumbsMenu));
    ...
    public function testDelete(): void
    {
        ...
        $this->assertSame('breadcrumbs', $breadcrumbsMenu->getIdentifier());
        $this->assertSame(['admin_home', 'admin_camp_category_list', 'admin_camp_category_delete'], $this->getGraphNodeChildrenIdentifiers($breadcrumbsMenu));
