...
class PurchasableItemVariantValueCreatedEventTest extends TestCase
{
    ...
    private PurchasableItemVariantValueCreatedEvent $event;
    ...
    protected function setUp(): void
    {
        ...
        $this->event = new PurchasableItemVariantValueCreatedEvent($this->data, $this->purchasableItemVariantValue);
    }
}