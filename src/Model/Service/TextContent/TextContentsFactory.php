...
{
    const PLACEHOLDER_TINY = 'Lorem ipsum';
    const PLACEHOLDER_SHORT = 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Pellentesque arcu.';
    ...
    {
        $paymentMethods['home_page_welcome'] = new TextContent('home_page_welcome', false, self::PLACEHOLDER_TINY);
        ...
        $paymentMethods['company_description'] = new TextContent('company_description', false, self::PLACEHOLDER_SHORT);
