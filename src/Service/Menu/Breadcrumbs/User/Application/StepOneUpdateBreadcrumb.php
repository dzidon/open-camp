...
class StepOneUpdateBreadcrumb extends AbstractBreadcrumb implements BreadcrumbInterface
{
    public function getSupportedRoute(): string
    {
        return 'user_application_step_one_update';
    }
    ...
    public function buildBreadcrumb(MenuTypeInterface $breadcrumbs, array $options): void
    {
        ...
        $this->addRoute($breadcrumbs, 'user_application_step_one_update', ['applicationId' => $applicationId])
            ->setText($text)
        ;
    }
