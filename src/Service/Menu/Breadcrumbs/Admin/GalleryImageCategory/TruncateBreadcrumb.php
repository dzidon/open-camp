...
class TruncateBreadcrumb extends AbstractBreadcrumb implements BreadcrumbInterface
{
    public function getSupportedRoute(): string
    {
        return 'admin_gallery_image_category_truncate';
    }
    ...
    public function buildBreadcrumb(MenuTypeInterface $breadcrumbs, array $options): void
    {
        ...
        $this->addRoute($breadcrumbs, 'admin_gallery_image_category_truncate', [
