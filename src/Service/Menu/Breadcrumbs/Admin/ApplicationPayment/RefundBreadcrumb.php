...
class RefundBreadcrumb extends AbstractBreadcrumb implements BreadcrumbInterface
{
    public function getSupportedRoute(): string
    {
        return 'admin_application_payment_refund';
    }
    ...
    public function buildBreadcrumb(MenuTypeInterface $breadcrumbs, array $options): void
    {
        ...
        $this->addRoute($breadcrumbs, 'admin_application_payment_refund', [
