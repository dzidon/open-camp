...
use App\Model\Event\Admin\ApplicationPurchasableItemInstance\ApplicationPurchasableItemInstanceCreateEvent;
    ...
    public function fillData(object $data, object $entity): void
    {
        ...
        if (empty($applicationPurchasableItemInstancesFromCamper))
        {
            $applicationPurchasableItemInstanceData = $this->applicationPurchasableItemInstanceDataFactory
                ->createForAdminModule($applicationPurchasableItem)
            ;
