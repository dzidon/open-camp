...
class DataTransferRegistry implements DataTransferRegistryInterface
{
    ...
    public function fillData(object $data, object $entity): void
    {
        ...
        throw new LogicException(
            sprintf('Method "fillData" cannot be used. There is no DataTransfer that supports data "%s" and entity "%s".', $data::class, $entity::class)
        );
    }
    ...
    public function fillEntity(object $data, object $entity): void
    {
        ...
        throw new LogicException(
            sprintf('Method "fillEntity" cannot be used. There is no DataTransfer that supports data "%s" and entity "%s".', $data::class, $entity::class)
        );
    }
}